...
public class AnimalPicturePanel1 extends JPanel {
	public AnimalPicturePanel1(){
		...
		pet1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JLabel jp2 = (JLabel) jp1.getComponent(0);
		    	jp2.setText("Used Action Number: N/A");
		...
		if(PetGame.player.getAnimals().size()>=1){
			...
			pet1.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					JPanel jp1 = (JPanel) jp.getComponent(1);
					JLabel jp2 = (JLabel) jp1.getComponent(0);
			    	jp2.setText("Used Action Number: "+PetGame.animal.getActionNumber());
			    	if(!PetGame.animal.isAlive()){
			    		jp2.setText("Used Action Number: N/A");
			    	}
